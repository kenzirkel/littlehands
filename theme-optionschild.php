...
function pinboard_social_media_options() {
	...
	add_settings_field( 'pinboard_instagram_link', __( 'instagram Account', 'pinboard' ), 'pinboard_instagram_link', 'pinboard_options', 'pinboard_social_media_options' );
...
function pinboard_instagram_link() { ?>
	<input name="pinboard_theme_options[instagram_link]" type="text" value="<?php echo pinboard_get_option( 'instagram_link' ); ?>" />
<?php
}
...
function pinboard_validate_theme_options( $input ) {
	if( isset( $input['submit-general'] ) || isset( $input['reset-general'] ) ) {
		...
		$input['instagram_link'] = esc_url_raw( $input['instagram_link'] );
